                   ...
                   $.ajax({
                       ...
                       success: function(data){
                           if(data.status==200)
                           {
                               ...
                               $(".message").removeClass("success-error");
                               $('.message').addClass('success-ok');
                               $('.message').html('<span>Su pedido se realizo con exito </span>');
                               $('#btn-pedido').html('Enviar');
                               $(".message").slideDown('slow', function () {
                                   setTimeout(function () {
                                       $(".message").slideUp('slow');
                                   }, 3000);
                   ...
                   $.ajax({
                       ...
                       success: function(data){
                           if(data.status==200)
                           {
                               ...
                               $(".message").removeClass("success-error");
                               $('.message').addClass('success-ok');
                               $('.message').html('<span>Su pedido se realizo con exito  y tambien se suscribio exitosamente </span>');
                               $('#btn-pedido').html('Enviar');
                               $(".message").slideDown('slow', function () {
                                   setTimeout(function () {
                                       $(".message").slideUp('slow');
                           ...
                           else
                           {
                              $('.oculto').show('slow');
                               $(".message").removeClass("success-ok");
                               $('.message').addClass('success-error');
                               $('.message').html('<span>Lo sentimos ocurrio un error intentelo mas tarde</span>');
                               $(".message").slideDown('slow', function () {
                                   setTimeout(function () {
                                       $(".message").slideUp('slow');
                                   }, 3000);
